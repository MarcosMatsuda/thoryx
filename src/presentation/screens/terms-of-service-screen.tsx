  ...
  return (
    <SafeAreaView className="flex-1 bg-background-primary" edges={['top', 'bottom']}>
      ...
      <ThoryxHeader
        ...
        center={<Text className="text-lg font-semibold text-text-primary">Terms of Service</Text>}
      />
        ...
        <View className="px-6 py-8">
          ...
          <View className="mb-8">
            ...
            <Text className="text-base md:text-lg text-text-secondary leading-relaxed">
              By using Thoryx, you agree to these Terms of Service. If you do not agree, do not use the app.
            </Text>
          </View>
          ...
          <View className="mb-8">
            ...
            <Text className="text-base md:text-lg text-text-secondary leading-relaxed">
              Thoryx is a personal security vault for storing documents, cards, and emergency information locally on your device. No data is sent to external servers.
            </Text>
          </View>
          ...
          <View className="mb-8">
            ...
            <Text className="text-base md:text-lg text-text-secondary leading-relaxed">
              All data you store in Thoryx — including documents, cards, and emergency contacts — is saved exclusively on your device. Thoryx does not have access to your data and cannot recover it if lost.
            </Text>
          </View>
          ...
          <View className="mb-8">
            ...
            <Text className="text-base md:text-lg text-text-secondary leading-relaxed">
              To the maximum extent permitted by law, Thoryx and its developers are not liable for any loss of data, loss of access, or damages arising from use of the app.
            </Text>
          </View>
