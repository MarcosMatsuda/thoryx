  ...
  return (
    ...
    >
      ...
      <ThoryxHeader
        ...
        center={
          <Text className="text-lg font-semibold text-light-text dark:text-text-primary">
            Privacy Policy
          </Text>
        }
      />
      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        <View className="px-6 py-8">
          {/* Title */}
          <Text className="text-2xl md:text-3xl font-bold text-light-text dark:text-text-primary mb-2">
            Privacy Policy — Thoryx
          </Text>
          <Text className="text-sm md:text-base text-light-textSecondary dark:text-text-secondary mb-8">
            Last updated: March 2026
          </Text>

          {/* Section 1: No Data Collection */}
          <View className="mb-8">
            <Text className="text-lg md:text-xl font-semibold text-light-text dark:text-text-primary mb-3">
              1. No Data Collection
            </Text>
            <Text className="text-base md:text-lg text-light-textSecondary dark:text-text-secondary leading-relaxed">
          ...
          <View className="mb-8">
            ...
            <Text className="text-base md:text-lg text-light-textSecondary dark:text-text-secondary leading-relaxed mb-2">
              Thoryx only requests permissions when you choose to use specific
              features:
            </Text>
            <View className="ml-4">
              <Text className="text-base md:text-lg text-light-textSecondary dark:text-text-secondary leading-relaxed mb-1">
