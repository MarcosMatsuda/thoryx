  ...
  return (
    <SafeAreaView className="flex-1 bg-background-primary" edges={['top', 'bottom']}>
      ...
      <ThoryxHeader
        ...
        center={<Text className="text-lg font-semibold text-text-primary">Privacy Policy</Text>}
      />
        ...
        <View className="px-6 py-8">
          ...
          <View className="mb-8">
            ...
            <Text className="text-base md:text-lg text-text-secondary leading-relaxed">
              Thoryx does not collect, transmit, or store any personal data. All information you enter — documents, cards, emergency contacts, PINs — stays exclusively on your device.
            </Text>
          </View>
          ...
          <View className="mb-8">
            ...
            <Text className="text-base md:text-lg text-text-secondary leading-relaxed">
              Your data is saved locally using encrypted storage (SecureStorage). We have no access to your data and cannot recover it if you lose your device or uninstall the app.
            </Text>
          </View>
          ...
          <View className="mb-8">
            ...
            <Text className="text-base md:text-lg text-text-secondary leading-relaxed">
              Thoryx does not use analytics, tracking, cookies, or any third‑party services that could identify you or your usage.
            </Text>
          </View>
          ...
          <View className="mb-8">
            ...
            <Text className="text-base md:text-lg text-text-secondary leading-relaxed mb-2">
              Thoryx only requests permissions when you choose to use specific features:
            </Text>
            <View className="ml-4">
              <Text className="text-base md:text-lg text-text-secondary leading-relaxed mb-1">
                • Camera: Used only when you choose to take a photo for your profile picture. Images are stored locally and never leave your device.
              </Text>
              <Text className="text-base md:text-lg text-text-secondary leading-relaxed">
                • Photo Library: Used only when you choose a photo from your library for your profile picture. Images are stored locally and never leave your device.
              </Text>
            </View>
          </View>
          ...
          <View className="mb-8">
            ...
            <Text className="text-base md:text-lg text-text-secondary leading-relaxed">
              For questions about this Privacy Policy, contact us at support@thoryx.app
            </Text>
          </View>
