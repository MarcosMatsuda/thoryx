    ...
    <SafeAreaView className="flex-1 bg-background-primary" edges={['top']}>
      <View className="flex-1">
        <View className="flex-row items-center justify-between px-6 py-4 border-b border-ui-border">
          ...
          <Pressable>
            <Text className="text-base md:text-lg font-semibold text-primary-main">Help</Text>
          </Pressable>
        </View>
              ...
              <View className="flex-row items-start">
                ...
                <View className="flex-1">
                  ...
                  <Text className="text-xs md:text-sm text-text-secondary leading-5">
                    Once confirmed, your device will be locked to this screen. Biometric authentication will be required to exit and access the rest of your app.
                  </Text>
                </View>
              </View>
            </View>
            ...
            <View className="bg-background-secondary rounded-2xl p-4 md:p-5 mb-6 flex-row items-center justify-between">
              <View className="flex-row items-center">
                ...
                <Text className="text-base md:text-lg font-semibold text-text-primary">
                  You are sharing <Text className="text-primary-main">{selectedDocs.length}</Text> documents
                </Text>
              </View>
            </View>
          </View>
