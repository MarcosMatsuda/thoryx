...
interface SvgIconProps {
  name: 'new-card' | 'triangle-allergies' | 'add-doc' | 'verified-shield' | 'lock-unlock';
  width?: number;
  height?: number;
  color?: string;
}
...
export function SvgIcon({ name, width = 24, height = 24, color = '#FFFFFF' }: SvgIconProps) {
  return <SvgXml xml={svgIcons[name]} width={width} height={height} color={color} />;
}
